...
echo "Penjumlahan : ".hitung( new Penjumlahan(10, 5)). PHP_EOL;
echo "Pengurangan : ".hitung( new Pengurangan(10, 5)). PHP_EOL;
echo "Pembagian : ".hitung( new Pembagian(10, 5)). PHP_EOL;
echo "Perkalian : ".hitung( new Perkalian(10, 5)). PHP_EOL;
